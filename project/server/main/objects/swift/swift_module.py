...
from project.server.main.objects.swift.tca.module import SwiftTCAModule
...
class SwiftModule:
    ...
    states: [SwiftState]
    actions: [SwiftAction]
    module_imports: [SwiftModuleImport]
    submodules: [SwiftSubmodule]
    extra_info: dict
    ...
    def initializer(self):
        values = [
            "{name}: {type}{default_value}".format(name=x.name, type=x.type, default_value=x.default_value is not "" and " = {}".format(x.default_value) or "")
